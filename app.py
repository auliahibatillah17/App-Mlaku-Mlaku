...
def home():
    Kota = "East+Java"
    url = "https://maps.googleapis.com/maps/api/place/textsearch/json?query=Tourists+Destinations+In+Jawa+Timur&type=tourist_attraction$language=en&key=AIzaSyCDBFhximQ7r34GQIfZTa6MzKbVRBsRDFs"
