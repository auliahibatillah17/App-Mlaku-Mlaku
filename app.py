...
def home():
    Kota = "East+Java"
    url = "https://maps.googleapis.com/maps/api/place/textsearch/json?query=Tourist+Destination+In+"+Kota+"&type=tourist_attraction&region=id&language=en&key=AIzaSyCDBFhximQ7r34GQIfZTa6MzKbVRBsRDFs"
